# This file is a patched version of the esphome/ota/__init__.py file from the ESPHome project.
...
esphome = cg.esphome_ns.namespace("meshmesh")
ESPHomeOTAComponent = esphome.class_("MeshmeshOTAComponent", OTAComponent)
